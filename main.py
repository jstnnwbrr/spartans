...
# ==========================================
    ...
    # ==========================================
        ...
        with tab_objs[1]:
            ...
            fig_field.add_trace(go.line(x=player_stats['Season'], y=player_stats[['TC', 'A', 'PO']], name="Fielding Chances & Plays Made"), secondary_y=False, markers=True)
            fig_field.add_trace(go.line(x=player_stats['Season'], y=player_stats[['FPCT', 'E', 'E%']], name="Fielding Percentage & Errors"), secondary_y=True, markerts=True)
